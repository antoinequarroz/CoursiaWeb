...
export const componentCatalogItems: ComponentCatalogItem[] = [
  ...
  },
  {
    ...
    productionComponent: 'BrandLogo',
    usefulProps: ['compact', 'iconClass', 'textClass'],
    variants: ['complet', 'compact', 'sidebar', 'topbar'],
    useCases: ['navigation admin', 'landing publique', 'page login', 'footer'],
    accessibility: ['texte de marque lisible', 'icône décorative aria-hidden', 'contraste vérifié'],
  },
  {
    id: 'theme-toggle',
    title: 'Sélecteur de thème',
    productionComponent: 'ThemeToggle',
    usefulProps: ['aucune prop publique'],
    variants: ['clair', 'sombre', 'état actif'],
    useCases: ['topbar publique', 'login admin', 'catalogue composants'],
    accessibility: ['bouton clavier', 'libellé explicite', 'état actif visible hors couleur'],
  },
  {
    id: 'nav-icons',
    title: 'Pictogrammes admin',
    productionComponent: 'NavIcon',
    usefulProps: ['name'],
    variants: ['dashboard', 'recipes', 'users', 'settings', 'notifications'],
    useCases: ['sidebar admin', 'recherche globale', 'notifications', 'actions rapides'],
    accessibility: ['icône décorative si le texte est présent', 'taille stable', 'ne remplace pas le libellé'],
  },
  {
    id: 'fields',
